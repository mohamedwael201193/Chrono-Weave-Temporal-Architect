...
import { Clock, Zap, Network, Trophy, Github, ExternalLink, Play, Star, Users, Target } from 'lucide-react'
import './App.css'
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className={`relative z-10 text-center max-w-6xl mx-auto px-6 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            <Button size="lg" className="temporal-glow energy-pulse text-lg px-8 py-6">
      ...
      <section className="py-24 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-16 max-w-3xl mx-auto">
            Leveraging cutting-edge web technologies and blockchain integration 
            for a seamless, high-performance gaming experience.
          </p>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { name: "Next.js", description: "React framework for optimal performance" },
              { name: "Three.js", description: "3D graphics and interactive visualizations" },
              { name: "Monad Testnet", description: "Blockchain integration and leaderboards" },
              { name: "Web3.js", description: "Seamless blockchain interactions" }
            ].map((tech, index) => (
